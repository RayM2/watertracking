# Android Project 5 and 6 - Hydration Tracker
...
- [X] **At least one health metric is tracked (based on user input)**
  - Chosen metric(s): `Hydration/Water Tracking`
...
Water Tracker is a health metrics app that allows users to track their daily hydration and set goals, and view trends.
